...
load_dotenv(dotenv_path=r"C:\Users\User-02\Documents\Pycharm\Nueroflux Operations\.env")

print("Loaded .env from: C:\\Users\\User-02\\Documents\\Pycharm\\Nueroflux Operations\\.env")
